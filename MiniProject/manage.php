...
<body>
    <?php
        ...
        $nameplace = "SELECT name_location,province,details FROM location WHERE user_id='$id_user'";
        $result2 = mysqli_query($conn, $nameplace);
        ...
        <div id="modalEditData" class="modalEditData" >
            <div id="modalEdit" class="modalEdit">
                ...
                <div class="modalContent">
                    <form id="loginForm" action="update_data.php" method="post">
                        <div class="nameLocationEdit">
                            <a>ชื่อโบราณสถาน</a><br>
                            <input name="nameEdit" id="nameEdit" class="form-control" type="text" value="<?php echo $name_location; ?>">
                        </div>
                        <div class="provinceEdit">
                            <a>จังหวัด</a><br>
                            <input name="provEdit" id="provEdit" class="form-control" type="text" value="<?php echo $province; ?>">
                        </div>
                        <div class="detailsEdit">
                            <a>รายละเอียด</a><br>
                            <textarea name="detEdit" id="detEdit" class="form-control" type="text" rows="6"><?php echo $details; ?></textarea>
                        </div>
            ...
            fetch('fetch_data.php')
                ...
                .then(data => {
                    ...
                    data.forEach(row => {
                        ...
                        newRow.insertCell(2).textContent = row.details;
